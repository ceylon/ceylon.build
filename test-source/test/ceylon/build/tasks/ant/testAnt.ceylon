import ceylon.build.tasks.ant { Ant, AntProject, activeAntProject, AntDefinition, AntAttributeDefinition, ant }
import ceylon.test { assertEquals, assertTrue, assertFalse, test, ignore }
...
"Test whether the `<ftp>` tasks exists, which is part of modul `org.apache.ant.ant-commons-net`.
 Depending of Ceylon's module implementation, this might not be available to the module `ceylon.build.tasks.ant`."
ignore("Current Ceylon module implementation does not allow injecting modules.")
