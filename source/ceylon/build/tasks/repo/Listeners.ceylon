...
shared class BuildTransferListener(Writer writer) satisfies TransferListener {
    ...
    shared actual void transferProgressed(TransferEvent e) {
        writer.info("``t`` ``e.resource.contentLength > 0 then ((e.transferredBytes * 100/e.resource.contentLength)) else e.transferredBytes/1000`` ``e.resource.contentLength>0 then "%" else "KB"`` transferred");
    }
